...
import { SIH2k23WinnersAPI } from "../../APIs/resultAPI";
import "../../stylesheets/ResultPageStyle.css";
import { Form, InputGroup } from "react-bootstrap";

const SIH2k23WinnersList = () => {
  const [data] = useState(SIH2k23WinnersAPI);
          ...
          <table className="table">
            ...
            <tbody>
              {data
                ...
                //         item.themeName.toLowerCase().includes(search) ||
...
export default SIH2k23WinnersList;
