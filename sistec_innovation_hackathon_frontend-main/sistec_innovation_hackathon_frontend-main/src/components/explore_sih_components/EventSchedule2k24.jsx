...
import {
  firstDayMorningSchedule2k24,
  firstDayAfterMorningSchedule2k24,
  secondDayMidNightSchedule2k24,
  secondDayMorningSchedule2k24,
} from "../../APIs/eventScheduleAPI";

function EventSchedule2k24() {
  const [firstDayMorning] = useState(firstDayMorningSchedule2k24);
  const [firstDayAfterMorning] = useState(firstDayAfterMorningSchedule2k24);
  const [secondDayMidNight] = useState(secondDayMidNightSchedule2k24);
  const [secondDayMorning] = useState(secondDayMorningSchedule2k24);
    ...
    <div className="container">
      <div className="text-center  mb-5">
        ...
        <span style={{ color: "var(--text-black-700)" }}>
          Here is the event schedule of SIH 2k24
        </span>
      </div>
