    ...
    <section className="form-wrap">
      <div className="form-container">
        <form onSubmit={handleSubmit} id="multi-step-form">
          ...
          >
            <h1 className="form-title">SIH 3.0 Registration Form</h1>
          ...
          >
            ...
            <p className="success-text">
              ...
              <br/><br/>
              <a href="https://chat.whatsapp.com/F0hsOEvs0Ie7biqt6GjbNW" target="_blank" rel="noopener noreferrer">https://chat.whatsapp.com/F0hsOEvs0Ie7biqt6GjbNW</a> 
              <br/><br/>
