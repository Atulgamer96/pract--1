...
const { registerTeam, deleteAllTeams, deleteTeamByName } = require('../controllers/teamController');
const upload = require('../middlewares/upload-middlewares'); // Cloudinary-based multer storage
...
// Register team with file uploads(Cludinary)
router.post(
  "/register",
  upload.fields([
    { name: "ideaPPT", maxCount: 1 },
...
// Delete all teams
// router.delete('/deleteAll', deleteAllTeams); 

// Delete specific team by name
router.delete('/delete/:teamName', deleteTeamByName);
